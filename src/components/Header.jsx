...
export function Header() {
  ...
  return (
    <header className="my-2">
      <nav className="relative py-4 px-4 flex justify-between items-center bg-white shadow-md">
      ...
      <div className="navbar-menu relative z-50 hidden">
        ...
        <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
          ...
          <div className="mt-auto">
            <div className="pt-6">
              <Link
                className="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold sm:leading-none bg-gray-50 hover:bg-gray-100 rounded-xl"
                to={"/Login"}
              >
                Sign In
              </Link>
